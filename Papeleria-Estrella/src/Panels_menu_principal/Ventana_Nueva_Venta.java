...
public class Ventana_Nueva_Venta {
    public static void main(String[] args){
        String opcion = JOptionPane.showInputDialog(null, "Opcion");
        if (opcion.equals("0")){
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(Panel_Nueva_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            } catch (InstantiationException ex) {
                java.util.logging.Logger.getLogger(Panel_Nueva_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            } catch (IllegalAccessException ex) {
                java.util.logging.Logger.getLogger(Panel_Nueva_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
